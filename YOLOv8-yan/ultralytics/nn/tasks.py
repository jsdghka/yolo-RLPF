...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 RepNCSPELAN4_low, C2f_DynamicConv, DynamicConv, Down_wt, C2f_GhostModule_DynamicConv, C2f_UIB,RFB_SPPF,
                 VoVGSCSPC,SPDEMA,RepVGGBlock,FCM,Pzconv,FCM_3,FCM_2,FCM_1,Down,DSConv,CSPPA):
        ...
        #---------------------------------------注意力机制------------------------
                   ...
                   SPDEMA, AirNet, ADNet, RIDNET,ScConv,ResCBAM}:
            c2 = ch[f]
            args = [c2, *args]
        # ---------------------------------------注意力机制-----------------------
        # ---------------------------------------主干----------------------------
